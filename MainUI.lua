...
local aa = {
    ...
    [47] = function()
        ...
        local af = {Names = {"Dark", "Darker", "Light", "Aqua", "Amethyst", "Rose", "Ocean", "Forest", "Sunset", "Midnight", "Cherry", "Lavender", "Gold", "Mint", "Crimson", "Sapphire", "Peach", "Galaxy"}}
    ...
    [54] = function()
        ...
        return {
            ...
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(20, 60, 100), Color3.fromRGB(10, 30, 50)),
            AcrylicNoise = 0.93,
            TitleBarLine = Color3.fromRGB(50, 100, 150),
            Tab = Color3.fromRGB(100, 150, 200),
            Element = Color3.fromRGB(80, 130, 180),
            ElementBorder = Color3.fromRGB(30, 50, 70),
            InElementBorder = Color3.fromRGB(60, 100, 140),
            ElementTransparency = 0.85,
            ToggleSlider = Color3.fromRGB(80, 130, 180),
            ToggleToggled = Color3.fromRGB(10, 10, 20),
            SliderRail = Color3.fromRGB(80, 130, 180),
            DropdownFrame = Color3.fromRGB(120, 170, 220),
            DropdownHolder = Color3.fromRGB(25, 45, 65),
            DropdownBorder = Color3.fromRGB(20, 40, 60),
            DropdownOption = Color3.fromRGB(80, 130, 180),
            Keybind = Color3.fromRGB(80, 130, 180),
            Input = Color3.fromRGB(80, 130, 180),
            InputFocused = Color3.fromRGB(15, 25, 35),
            InputIndicator = Color3.fromRGB(100, 150, 200),
            Dialog = Color3.fromRGB(25, 45, 65),
            DialogHolder = Color3.fromRGB(20, 35, 50),
            DialogHolderLine = Color3.fromRGB(15, 30, 45),
            DialogButton = Color3.fromRGB(25, 45, 65),
            DialogButtonBorder = Color3.fromRGB(60, 100, 140),
            DialogBorder = Color3.fromRGB(40, 80, 120),
            DialogInput = Color3.fromRGB(30, 50, 70),
            DialogInputLine = Color3.fromRGB(100, 150, 200),
            Text = Color3.fromRGB(230, 240, 255),
            SubText = Color3.fromRGB(160, 180, 200),
            Hover = Color3.fromRGB(80, 130, 180),
            HoverChange = 0.05
        }
    end,
    [55] = function()
        ...
        return {
            ...
            AcrylicBorder = Color3.fromRGB(60, 90, 60),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 70, 40), Color3.fromRGB(20, 40, 20)),
            AcrylicNoise = 0.91,
            TitleBarLine = Color3.fromRGB(70, 110, 70),
            Tab = Color3.fromRGB(120, 160, 120),
            Element = Color3.fromRGB(100, 140, 100),
            ElementBorder = Color3.fromRGB(40, 60, 40),
            InElementBorder = Color3.fromRGB(70, 100, 70),
            ElementTransparency = 0.86,
            ToggleSlider = Color3.fromRGB(100, 140, 100),
            ToggleToggled = Color3.fromRGB(10, 15, 10),
            SliderRail = Color3.fromRGB(100, 140, 100),
            DropdownFrame = Color3.fromRGB(140, 180, 140),
            DropdownHolder = Color3.fromRGB(35, 55, 35),
            DropdownBorder = Color3.fromRGB(30, 50, 30),
            DropdownOption = Color3.fromRGB(100, 140, 100),
            Keybind = Color3.fromRGB(100, 140, 100),
            Input = Color3.fromRGB(100, 140, 100),
            InputFocused = Color3.fromRGB(15, 25, 15),
            InputIndicator = Color3.fromRGB(120, 160, 120),
            Dialog = Color3.fromRGB(35, 55, 35),
            DialogHolder = Color3.fromRGB(25, 45, 25),
            DialogHolderLine = Color3.fromRGB(20, 40, 20),
            DialogButton = Color3.fromRGB(35, 55, 35),
            DialogButtonBorder = Color3.fromRGB(70, 100, 70),
            DialogBorder = Color3.fromRGB(60, 90, 60),
            DialogInput = Color3.fromRGB(40, 65, 40),
            DialogInputLine = Color3.fromRGB(120, 160, 120),
            Text = Color3.fromRGB(230, 245, 230),
            SubText = Color3.fromRGB(170, 190, 170),
            Hover = Color3.fromRGB(100, 140, 100),
            HoverChange = 0.05
        }
    end,
    [56] = function()
        ...
        return {
            ...
            AcrylicBorder = Color3.fromRGB(120, 70, 80),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(180, 80, 60), Color3.fromRGB(120, 40, 50)),
            AcrylicNoise = 0.90,
            TitleBarLine = Color3.fromRGB(140, 80, 90),
            Tab = Color3.fromRGB(200, 130, 120),
            Element = Color3.fromRGB(180, 110, 100),
            ElementBorder = Color3.fromRGB(80, 50, 55),
            InElementBorder = Color3.fromRGB(120, 80, 85),
            ElementTransparency = 0.84,
            ToggleSlider = Color3.fromRGB(180, 110, 100),
            ToggleToggled = Color3.fromRGB(20, 10, 15),
            SliderRail = Color3.fromRGB(180, 110, 100),
            DropdownFrame = Color3.fromRGB(200, 150, 140),
            DropdownHolder = Color3.fromRGB(60, 35, 40),
            DropdownBorder = Color3.fromRGB(50, 30, 35),
            DropdownOption = Color3.fromRGB(180, 110, 100),
            Keybind = Color3.fromRGB(180, 110, 100),
            Input = Color3.fromRGB(180, 110, 100),
            InputFocused = Color3.fromRGB(25, 15, 20),
            InputIndicator = Color3.fromRGB(200, 130, 120),
            Dialog = Color3.fromRGB(60, 35, 40),
            DialogHolder = Color3.fromRGB(45, 25, 30),
            DialogHolderLine = Color3.fromRGB(40, 20, 25),
            DialogButton = Color3.fromRGB(60, 35, 40),
            DialogButtonBorder = Color3.fromRGB(120, 80, 85),
            DialogBorder = Color3.fromRGB(100, 60, 70),
            DialogInput = Color3.fromRGB(70, 40, 45),
            DialogInputLine = Color3.fromRGB(200, 130, 120),
            Text = Color3.fromRGB(255, 240, 230),
            SubText = Color3.fromRGB(200, 170, 160),
            Hover = Color3.fromRGB(180, 110, 100),
            HoverChange = 0.06
        }
    end,
    [57] = function()
        ...
        return {
            ...
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 25, 60), Color3.fromRGB(15, 10, 35)),
            AcrylicNoise = 0.95,
            TitleBarLine = Color3.fromRGB(60, 50, 90),
            Tab = Color3.fromRGB(100, 90, 140),
            Element = Color3.fromRGB(80, 70, 120),
            ElementBorder = Color3.fromRGB(30, 25, 50),
            InElementBorder = Color3.fromRGB(60, 50, 90),
            ElementTransparency = 0.88,
            ToggleSlider = Color3.fromRGB(80, 70, 120),
            ToggleToggled = Color3.fromRGB(5, 5, 15),
            SliderRail = Color3.fromRGB(80, 70, 120),
            DropdownFrame = Color3.fromRGB(120, 110, 160),
            DropdownHolder = Color3.fromRGB(25, 20, 45),
            DropdownBorder = Color3.fromRGB(20, 15, 40),
            DropdownOption = Color3.fromRGB(80, 70, 120),
            Keybind = Color3.fromRGB(80, 70, 120),
            Input = Color3.fromRGB(80, 70, 120),
            InputFocused = Color3.fromRGB(10, 10, 25),
            InputIndicator = Color3.fromRGB(100, 90, 140),
            Dialog = Color3.fromRGB(25, 20, 45),
            DialogHolder = Color3.fromRGB(20, 15, 35),
            DialogHolderLine = Color3.fromRGB(15, 10, 30),
            DialogButton = Color3.fromRGB(25, 20, 45),
            DialogButtonBorder = Color3.fromRGB(60, 50, 90),
            DialogBorder = Color3.fromRGB(50, 40, 80),
            DialogInput = Color3.fromRGB(30, 25, 50),
            DialogInputLine = Color3.fromRGB(100, 90, 140),
            Text = Color3.fromRGB(235, 235, 255),
            SubText = Color3.fromRGB(170, 165, 200),
    ...
    [58] = function()
        ...
        return {
            ...
            AcrylicMain = Color3.fromRGB(30, 15, 20),
            AcrylicBorder = Color3.fromRGB(100, 50, 70),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(150, 40, 70), Color3.fromRGB(80, 20, 40)),
            AcrylicNoise = 0.91,
            TitleBarLine = Color3.fromRGB(120, 60, 80),
            Tab = Color3.fromRGB(170, 110, 130),
            Element = Color3.fromRGB(150, 90, 110),
            ElementBorder = Color3.fromRGB(60, 30, 45),
            InElementBorder = Color3.fromRGB(100, 70, 85),
            ElementTransparency = 0.85,
            ToggleSlider = Color3.fromRGB(150, 90, 110),
            ToggleToggled = Color3.fromRGB(15, 5, 10),
            SliderRail = Color3.fromRGB(150, 90, 110),
            DropdownFrame = Color3.fromRGB(190, 130, 150),
            DropdownHolder = Color3.fromRGB(50, 25, 35),
            DropdownBorder = Color3.fromRGB(40, 20, 30),
            DropdownOption = Color3.fromRGB(150, 90, 110),
            Keybind = Color3.fromRGB(150, 90, 110),
            Input = Color3.fromRGB(150, 90, 110),
            InputFocused = Color3.fromRGB(20, 10, 15),
            InputIndicator = Color3.fromRGB(170, 110, 130),
            Dialog = Color3.fromRGB(50, 25, 35),
            DialogHolder = Color3.fromRGB(40, 20, 30),
            DialogHolderLine = Color3.fromRGB(35, 15, 25),
            DialogButton = Color3.fromRGB(50, 25, 35),
            DialogButtonBorder = Color3.fromRGB(100, 70, 85),
            DialogBorder = Color3.fromRGB(80, 50, 65),
            DialogInput = Color3.fromRGB(60, 30, 45),
            DialogInputLine = Color3.fromRGB(170, 110, 130),
            Text = Color3.fromRGB(255, 235, 240),
            SubText = Color3.fromRGB(200, 170, 180),
            Hover = Color3.fromRGB(150, 90, 110),
            HoverChange = 0.05
        }
    end,
    [59] = function()
        ...
        return {
            ...
            AcrylicBorder = Color3.fromRGB(90, 75, 120),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(110, 90, 150), Color3.fromRGB(60, 45, 90)),
            AcrylicNoise = 0.93,
            TitleBarLine = Color3.fromRGB(100, 85, 130),
            Tab = Color3.fromRGB(160, 140, 190),
            Element = Color3.fromRGB(140, 120, 170),
            ElementBorder = Color3.fromRGB(55, 45, 75),
            InElementBorder = Color3.fromRGB(95, 80, 125),
            ElementTransparency = 0.86,
            ToggleSlider = Color3.fromRGB(140, 120, 170),
            ToggleToggled = Color3.fromRGB(10, 5, 15),
            SliderRail = Color3.fromRGB(140, 120, 170),
            DropdownFrame = Color3.fromRGB(180, 160, 210),
            DropdownHolder = Color3.fromRGB(45, 35, 65),
            DropdownBorder = Color3.fromRGB(40, 30, 60),
            DropdownOption = Color3.fromRGB(140, 120, 170),
            Keybind = Color3.fromRGB(140, 120, 170),
            Input = Color3.fromRGB(140, 120, 170),
            InputFocused = Color3.fromRGB(18, 13, 28),
            InputIndicator = Color3.fromRGB(160, 140, 190),
            Dialog = Color3.fromRGB(45, 35, 65),
            DialogHolder = Color3.fromRGB(35, 28, 55),
            DialogHolderLine = Color3.fromRGB(30, 23, 50),
            DialogButton = Color3.fromRGB(45, 35, 65),
            DialogButtonBorder = Color3.fromRGB(95, 80, 125),
            DialogBorder = Color3.fromRGB(80, 65, 110),
            DialogInput = Color3.fromRGB(55, 45, 75),
            DialogInputLine = Color3.fromRGB(160, 140, 190),
            Text = Color3.fromRGB(245, 240, 255),
            SubText = Color3.fromRGB(180, 170, 200),
            Hover = Color3.fromRGB(140, 120, 170),
            HoverChange = 0.05
        }
    end,
    [60] = function()
        ...
        return {
            ...
            AcrylicMain = Color3.fromRGB(30, 25, 15),
            AcrylicBorder = Color3.fromRGB(120, 100, 50),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(150, 120, 50), Color3.fromRGB(80, 65, 25)),
            AcrylicNoise = 0.89,
            TitleBarLine = Color3.fromRGB(130, 110, 60),
            Tab = Color3.fromRGB(180, 150, 90),
            Element = Color3.fromRGB(160, 135, 75),
            ElementBorder = Color3.fromRGB(70, 60, 30),
            InElementBorder = Color3.fromRGB(110, 95, 50),
            ElementTransparency = 0.83,
            ToggleSlider = Color3.fromRGB(160, 135, 75),
            ToggleToggled = Color3.fromRGB(15, 12, 5),
            SliderRail = Color3.fromRGB(160, 135, 75),
            DropdownFrame = Color3.fromRGB(200, 170, 100),
            DropdownHolder = Color3.fromRGB(50, 42, 20),
            DropdownBorder = Color3.fromRGB(45, 38, 18),
            DropdownOption = Color3.fromRGB(160, 135, 75),
            Keybind = Color3.fromRGB(160, 135, 75),
            Input = Color3.fromRGB(160, 135, 75),
            InputFocused = Color3.fromRGB(20, 17, 8),
            InputIndicator = Color3.fromRGB(180, 150, 90),
            Dialog = Color3.fromRGB(50, 42, 20),
            DialogHolder = Color3.fromRGB(40, 35, 16),
            DialogHolderLine = Color3.fromRGB(35, 30, 14),
            DialogButton = Color3.fromRGB(50, 42, 20),
            DialogButtonBorder = Color3.fromRGB(110, 95, 50),
            DialogBorder = Color3.fromRGB(90, 75, 40),
            DialogInput = Color3.fromRGB(60, 50, 25),
            DialogInputLine = Color3.fromRGB(180, 150, 90),
            Text = Color3.fromRGB(255, 250, 230),
            SubText = Color3.fromRGB(200, 185, 150),
            Hover = Color3.fromRGB(160, 135, 75),
            HoverChange = 0.06
        }
    end,
    [61] = function()
        ...
        return {
            Name = "Mint",
            Accent = Color3.fromRGB(62, 180, 137),
            AcrylicMain = Color3.fromRGB(18, 28, 25),
            AcrylicBorder = Color3.fromRGB(60, 100, 85),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(50, 120, 95), Color3.fromRGB(30, 70, 55)),
            AcrylicNoise = 0.92,
            TitleBarLine = Color3.fromRGB(70, 115, 95),
            Tab = Color3.fromRGB(130, 180, 160),
            Element = Color3.fromRGB(110, 160, 140),
            ElementBorder = Color3.fromRGB(40, 65, 55),
            InElementBorder = Color3.fromRGB(75, 110, 95),
            ElementTransparency = 0.85,
            ToggleSlider = Color3.fromRGB(110, 160, 140),
            ToggleToggled = Color3.fromRGB(8, 13, 11),
            SliderRail = Color3.fromRGB(110, 160, 140),
            DropdownFrame = Color3.fromRGB(150, 200, 180),
            DropdownHolder = Color3.fromRGB(30, 50, 43),
            DropdownBorder = Color3.fromRGB(25, 45, 38),
            DropdownOption = Color3.fromRGB(110, 160, 140),
            Keybind = Color3.fromRGB(110, 160, 140),
            Input = Color3.fromRGB(110, 160, 140),
            InputFocused = Color3.fromRGB(13, 23, 20),
            InputIndicator = Color3.fromRGB(130, 180, 160),
            Dialog = Color3.fromRGB(30, 50, 43),
            DialogHolder = Color3.fromRGB(23, 40, 35),
            DialogHolderLine = Color3.fromRGB(18, 35, 30),
            DialogButton = Color3.fromRGB(30, 50, 43),
            DialogButtonBorder = Color3.fromRGB(75, 110, 95),
            DialogBorder = Color3.fromRGB(60, 95, 80),
            DialogInput = Color3.fromRGB(38, 60, 52),
            DialogInputLine = Color3.fromRGB(130, 180, 160),
            Text = Color3.fromRGB(240, 255, 250),
            SubText = Color3.fromRGB(170, 200, 190),
            Hover = Color3.fromRGB(110, 160, 140),
            HoverChange = 0.05
        }
    end,
    [62] = function()
        ...
        return {
            ...
            AcrylicBorder = Color3.fromRGB(100, 50, 50),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(140, 40, 40), Color3.fromRGB(70, 20, 20)),
            AcrylicNoise = 0.90,
            TitleBarLine = Color3.fromRGB(115, 55, 55),
            Tab = Color3.fromRGB(170, 100, 100),
            Element = Color3.fromRGB(150, 85, 85),
            ElementBorder = Color3.fromRGB(60, 30, 30),
            InElementBorder = Color3.fromRGB(100, 60, 60),
            ElementTransparency = 0.84,
            ToggleSlider = Color3.fromRGB(150, 85, 85),
            ToggleToggled = Color3.fromRGB(12, 5, 5),
            SliderRail = Color3.fromRGB(150, 85, 85),
            DropdownFrame = Color3.fromRGB(190, 120, 120),
            DropdownHolder = Color3.fromRGB(45, 25, 25),
            DropdownBorder = Color3.fromRGB(38, 20, 20),
            DropdownOption = Color3.fromRGB(150, 85, 85),
            Keybind = Color3.fromRGB(150, 85, 85),
            Input = Color3.fromRGB(150, 85, 85),
            InputFocused = Color3.fromRGB(18, 10, 10),
            InputIndicator = Color3.fromRGB(170, 100, 100),
            Dialog = Color3.fromRGB(45, 25, 25),
            DialogHolder = Color3.fromRGB(35, 20, 20),
            DialogHolderLine = Color3.fromRGB(30, 15, 15),
            DialogButton = Color3.fromRGB(45, 25, 25),
            DialogButtonBorder = Color3.fromRGB(100, 60, 60),
            DialogBorder = Color3.fromRGB(80, 45, 45),
            DialogInput = Color3.fromRGB(55, 30, 30),
            DialogInputLine = Color3.fromRGB(170, 100, 100),
            Text = Color3.fromRGB(255, 240, 240),
            SubText = Color3.fromRGB(200, 170, 170),
            Hover = Color3.fromRGB(150, 85, 85),
            HoverChange = 0.05
        }
    end,
    [63] = function()
        ...
        return {
            ...
            AcrylicMain = Color3.fromRGB(12, 18, 30),
            AcrylicBorder = Color3.fromRGB(45, 70, 110),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(35, 60, 120), Color3.fromRGB(18, 30, 65)),
            AcrylicNoise = 0.94,
            TitleBarLine = Color3.fromRGB(55, 80, 125),
            Tab = Color3.fromRGB(100, 130, 180),
            Element = Color3.fromRGB(80, 110, 160),
            ElementBorder = Color3.fromRGB(30, 45, 70),
            InElementBorder = Color3.fromRGB(60, 85, 125),
            ElementTransparency = 0.87,
            ToggleSlider = Color3.fromRGB(80, 110, 160),
            ToggleToggled = Color3.fromRGB(5, 8, 15),
            SliderRail = Color3.fromRGB(80, 110, 160),
            DropdownFrame = Color3.fromRGB(120, 150, 200),
            DropdownHolder = Color3.fromRGB(22, 35, 58),
            DropdownBorder = Color3.fromRGB(18, 30, 52),
            DropdownOption = Color3.fromRGB(80, 110, 160),
            Keybind = Color3.fromRGB(80, 110, 160),
            Input = Color3.fromRGB(80, 110, 160),
            InputFocused = Color3.fromRGB(10, 15, 25),
            InputIndicator = Color3.fromRGB(100, 130, 180),
            Dialog = Color3.fromRGB(22, 35, 58),
            DialogHolder = Color3.fromRGB(17, 28, 48),
            DialogHolderLine = Color3.fromRGB(13, 23, 42),
            DialogButton = Color3.fromRGB(22, 35, 58),
            DialogButtonBorder = Color3.fromRGB(60, 85, 125),
            DialogBorder = Color3.fromRGB(45, 70, 110),
            DialogInput = Color3.fromRGB(28, 43, 70),
            DialogInputLine = Color3.fromRGB(100, 130, 180),
            Text = Color3.fromRGB(235, 242, 255),
            SubText = Color3.fromRGB(165, 180, 210),
            Hover = Color3.fromRGB(80, 110, 160),
            HoverChange = 0.04
        }
    end,
    [64] = function()
        ...
        return {
            Name = "Peach",
            Accent = Color3.fromRGB(255, 159, 128),
            AcrylicMain = Color3.fromRGB(30, 23, 20),
            AcrylicBorder = Color3.fromRGB(120, 90, 80),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(180, 120, 100), Color3.fromRGB(100, 70, 60)),
            AcrylicNoise = 0.91,
            TitleBarLine = Color3.fromRGB(135, 100, 90),
            Tab = Color3.fromRGB(190, 145, 130),
            Element = Color3.fromRGB(170, 130, 115),
            ElementBorder = Color3.fromRGB(75, 55, 50),
            InElementBorder = Color3.fromRGB(115, 85, 75),
            ElementTransparency = 0.84,
            ToggleSlider = Color3.fromRGB(170, 130, 115),
            ToggleToggled = Color3.fromRGB(15, 11, 10),
            SliderRail = Color3.fromRGB(170, 130, 115),
            DropdownFrame = Color3.fromRGB(210, 165, 150),
            DropdownHolder = Color3.fromRGB(55, 40, 35),
            DropdownBorder = Color3.fromRGB(48, 35, 30),
            DropdownOption = Color3.fromRGB(170, 130, 115),
            Keybind = Color3.fromRGB(170, 130, 115),
            Input = Color3.fromRGB(170, 130, 115),
            InputFocused = Color3.fromRGB(22, 16, 14),
            InputIndicator = Color3.fromRGB(190, 145, 130),
            Dialog = Color3.fromRGB(55, 40, 35),
            DialogHolder = Color3.fromRGB(43, 32, 28),
            DialogHolderLine = Color3.fromRGB(38, 28, 24),
            DialogButton = Color3.fromRGB(55, 40, 35),
            DialogButtonBorder = Color3.fromRGB(115, 85, 75),
            DialogBorder = Color3.fromRGB(95, 70, 62),
            DialogInput = Color3.fromRGB(65, 48, 42),
            DialogInputLine = Color3.fromRGB(190, 145, 130),
            Text = Color3.fromRGB(255, 245, 240),
            SubText = Color3.fromRGB(200, 180, 170),
            Hover = Color3.fromRGB(170, 130, 115),
            HoverChange = 0.06
        }
    end,
    [65] = function()
        ...
        return {
            ...
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(75, 40, 140), Color3.fromRGB(30, 15, 60)),
            AcrylicNoise = 0.96,
            TitleBarLine = Color3.fromRGB(80, 50, 120),
            Tab = Color3.fromRGB(130, 90, 180),
            Element = Color3.fromRGB(110, 75, 160),
            ElementBorder = Color3.fromRGB(40, 25, 65),
            InElementBorder = Color3.fromRGB(75, 50, 110),
            ElementTransparency = 0.89,
            ToggleSlider = Color3.fromRGB(110, 75, 160),
            ToggleToggled = Color3.fromRGB(5, 5, 10),
            SliderRail = Color3.fromRGB(110, 75, 160),
            DropdownFrame = Color3.fromRGB(150, 110, 200),
            DropdownHolder = Color3.fromRGB(20, 15, 40),
            DropdownBorder = Color3.fromRGB(15, 10, 35),
            DropdownOption = Color3.fromRGB(110, 75, 160),
            Keybind = Color3.fromRGB(110, 75, 160),
            Input = Color3.fromRGB(110, 75, 160),
            InputFocused = Color3.fromRGB(8, 8, 18),
            InputIndicator = Color3.fromRGB(130, 90, 180),
            Dialog = Color3.fromRGB(20, 15, 40),
            DialogHolder = Color3.fromRGB(15, 10, 30),
            DialogHolderLine = Color3.fromRGB(12, 8, 25),
            DialogButton = Color3.fromRGB(20, 15, 40),
            DialogButtonBorder = Color3.fromRGB(75, 50, 110),
            DialogBorder = Color3.fromRGB(60, 40, 95),
            DialogInput = Color3.fromRGB(28, 20, 50),
            DialogInputLine = Color3.fromRGB(130, 90, 180),
            Text = Color3.fromRGB(240, 235, 255),
            SubText = Color3.fromRGB(175, 165, 210),
            Hover = Color3.fromRGB(110, 75, 160),
            HoverChange = 0.04
        }
    end
}
