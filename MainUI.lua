...
local aa = {
    ...
    [57] = function()
        ...
        return {
            ...
            AcrylicMain = Color3.fromRGB(5, 5, 10),
            AcrylicBorder = Color3.fromRGB(240, 240, 255),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 10, 20), Color3.fromRGB(3, 3, 8)),
            AcrylicNoise = 0.95,
            TitleBarLine = Color3.fromRGB(240, 240, 255),
            Tab = Color3.fromRGB(220, 220, 255),
            Element = Color3.fromRGB(8, 8, 15),
            ElementBorder = Color3.fromRGB(240, 240, 255),
            InElementBorder = Color3.fromRGB(200, 200, 240),
            ElementTransparency = 0.05,
            ToggleSlider = Color3.fromRGB(220, 220, 255),
            ToggleToggled = Color3.fromRGB(3, 3, 6),
            SliderRail = Color3.fromRGB(220, 220, 255),
            DropdownFrame = Color3.fromRGB(8, 8, 15),
            DropdownHolder = Color3.fromRGB(5, 5, 10),
            DropdownBorder = Color3.fromRGB(240, 240, 255),
            DropdownOption = Color3.fromRGB(220, 220, 255),
            Keybind = Color3.fromRGB(220, 220, 255),
            Input = Color3.fromRGB(220, 220, 255),
            InputFocused = Color3.fromRGB(6, 6, 12),
            InputIndicator = Color3.fromRGB(240, 240, 255),
            Dialog = Color3.fromRGB(5, 5, 10),
            DialogHolder = Color3.fromRGB(4, 4, 8),
            DialogHolderLine = Color3.fromRGB(240, 240, 255),
            DialogButton = Color3.fromRGB(8, 8, 15),
            DialogButtonBorder = Color3.fromRGB(240, 240, 255),
            DialogBorder = Color3.fromRGB(240, 240, 255),
            DialogInput = Color3.fromRGB(12, 12, 20),
            DialogInputLine = Color3.fromRGB(220, 220, 255),
            Text = Color3.fromRGB(255, 255, 255),
            SubText = Color3.fromRGB(220, 220, 240),
            Hover = Color3.fromRGB(220, 220, 255),
            HoverChange = 0.12
        }
    end,
